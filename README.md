...
* `5.4.3`, `5.4` [(5.4/Dockerfile)](https://github.com/Khezen/docker-elasticsearch/blob/5.4/Dockerfile)
* `5.5.0`, `5.5`, `5`, `latest` [(5.5/Dockerfile)](https://github.com/Khezen/docker-elasticsearch/blob/5.5/Dockerfile)
